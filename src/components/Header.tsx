...
const Header = () => {
  ...
  return (
    <>
      ...
      <div className="bg-background text-white py-2 text-sm border-b border-white/20">
      ...
      <header className="sticky top-0 z-50 w-full bg-background border-b border-white/20 shadow-lg">
        <div className="container mx-auto px-4">
          <div className="flex h-16 items-center justify-between">
            {/* Logo integrated with background */}
            <Link to="/" className="flex items-center">
              <span className="text-2xl font-bold text-white font-source-sans tracking-wide">
                LAWFER
              </span>
            </Link>
            ...
            <Sheet open={isOpen} onOpenChange={setIsOpen}>
              ...
              <SheetContent side="right" className="w-80 bg-background border-white/20 text-white">
