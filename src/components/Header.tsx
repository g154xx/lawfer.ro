          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-6">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-foreground">+40 731 942 295</span>
              </div>
              <div className="flex items-center space-x-2">
                <Mail className="h-4 w-4 text-teal-400" />
                <span className="text-foreground">yarina@lawfer.ro</span>
              </div>
              <div className="hidden md:flex items-center space-x-2">
                <a href="https://wa.me/40731942295" target="_blank" rel="noopener noreferrer" className="flex items-center space-x-2 hover:text-teal-400 transition-colors">
