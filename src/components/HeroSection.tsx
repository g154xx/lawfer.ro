...
import { Gavel, Users, FileText, Scale } from "lucide-react";
import { Link } from "react-router-dom";

const HeroSection = () => {
  return (
    <section className="relative py-24 bg-background hero-background overflow-hidden">
      {/* Floating animated elements - Hogan Lovells style */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-bold mb-6 text-foreground font-source-serif leading-tight">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
            <div className="text-center bg-card/50 backdrop-blur-sm p-6 rounded-lg border">
              ...
              <div className="text-3xl font-bold text-primary mb-2 font-source-serif">15+</div>
            ...
            <div className="text-center bg-card/50 backdrop-blur-sm p-6 rounded-lg border">
              ...
              <div className="text-3xl font-bold text-primary mb-2 font-source-serif">500+</div>
            ...
            <div className="text-center bg-card/50 backdrop-blur-sm p-6 rounded-lg border">
              ...
              <div className="text-3xl font-bold text-primary mb-2 font-source-serif">24/7</div>
