...
const HeroSection = () => {
  return (
    <section className="relative py-32 bg-background hero-background overflow-hidden min-h-[700px] flex items-center">
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl">
          <p className="text-primary text-sm uppercase tracking-[0.3em] mb-4 font-source-sans">
            Suntem aici pentru tine cu
            <span className="text-foreground"> consultanță juridică </span>
            <span className="text-primary">servicii rapide</span>
          </p>
          
          <h1 className="text-5xl md:text-7xl font-bold mb-8 text-foreground font-playfair leading-tight">
            Avocat Lawfer
          </h1>
          
          <p className="text-lg md:text-xl text-muted-foreground mb-12 max-w-2xl font-source-sans leading-relaxed">
